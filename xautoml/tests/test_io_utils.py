...
def test_load_dataframe():
    ...
    xautoml_df = io_utils.load_output_dataframe(xautoml_pipeline, 'classifier', xautoml_X, xautoml_feature_labels)
    print(xautoml_df)
...
def test_subpipeline():
    for step in ['SOURCE', 'data_preprocessing', 'data_preprocessing:imputation', 'data_preprocessing:categorical',
        ...
        X, y, feature_labels, pipeline = BaseHandler.load_model({
            ...
            "model_files": "/home/marc/phd/code/dswizard/scripts/run/31/models/models_0-0-0.pkl"
        })
...
def test_subpipeline_autosklearn():
    # TODO use dataset with categorical features
